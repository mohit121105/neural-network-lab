...
data = [
    # clear flu cases
    ([1, 1, 1], 1),  # fever + cough + body pain
    ([1, 0, 1], 1),  # fever + body pain
    ([0, 1, 1], 1),  # cough + body pain
    ...
    # tricky / mixed cases
    ([1, 1, 0], 0),  # fever + cough but no body pain
    ([0, 1, 1], 1),  # duplicate (flu)
    ([1, 0, 1], 1),  # duplicate (flu)
]
